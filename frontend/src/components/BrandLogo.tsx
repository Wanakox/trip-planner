...
export function BrandLogo({ inverse = false }: BrandLogoProps) {
  return (
    <Stack component={RouterLink} direction="row" spacing={1.5} alignItems="center" to="/" sx={{ color: inverse ? 'white' : 'text.primary', textDecoration: 'none' }}>
      ...
      <Typography fontSize={22} fontWeight={800}>TripPlanner</Typography>
    </Stack>
  )
}
